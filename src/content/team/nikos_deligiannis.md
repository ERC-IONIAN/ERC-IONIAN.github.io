---
title: "Nikos Deligiannis"
role: "Professor"
date: 2001-01-01
image:
  path: /images/empty_banner.png
  thumbnail: /images/nikos_circle.jpg
author:
  name: Nikos Deligiannis
  picture: /images/nikos_circle.jpg
  email: Nikos.Deligiannis@vub.be
  links:
    - title: Email
      url: mailto:Nikos.Deligiannis@vub.be
      icon: email
    - title: Twitter
      url: https://twitter.com/prof_ndeligia
      icon: twitter
    - title: LinkedIn
      url: https://www.linkedin.com/in/nikos-deligiannis-a3b70a18/
      icon: linkedin
    - title: Facebook
      url: https://www.facebook.com/profile.php?id=100008041097046
      icon: facebook
    - title: Google Scholar
      url: http://scholar.google.gr/citations?user=iUGMLcYAAAAJ&hl=el&oi=ao
      icon: scholar
    - title: ORCID
